...
import com.messages.smartsms.common.IntroNavigation;
...
public class Intro4Activity extends AppCompatActivity {
    ...
    private void clickEvents() {
        IntroNavigation.setupIntroButtonIndicators(this, llIndicator, 4);
        ...
        if (!AdPlacement.getIntroButtonAdShow()) {
            ...
            if ("banner".equalsIgnoreCase(AdPlacement.getIntroButtonAdType())) {
                ...
                AdPlacement.loadBannerAd(this, AdPlacement.getIntroButtonBannerId4(), rlBannerAdView, slBannerShimmer, llBannerAd);
            } else {
                rlBannerAdView.setVisibility(View.GONE);
                rlNativeAdView.setVisibility(View.VISIBLE);
                AdPlacement.loadNativeAd(this, AdPlacement.getIntroButtonNativeId4(), rlNativeAdView, slNativeShimmer, flNativeAd, "small");
            }
        }

        btnNext.setOnClickListener(view -> IntroNavigation.goToNextIntroButtonScreen(Intro4Activity.this, 4));
    }
    ...
    protected void onResume() {
        super.onResume();
        if (tvTitle != null) {
            tvTitle.setText(getString(R.string.intro_4_title));
            tvDescription.setText(getString(R.string.intro_4_description));
