...
public class Intro1Activity extends AppCompatActivity {
    ...
    private void clickEvents() {
        ...
        if (!AdPlacement.getIntroButtonAdShow()) {
            ...
            if ("banner".equalsIgnoreCase(AdPlacement.getIntroButtonAdType())) {
                ...
                AdPlacement.loadBannerAd(this, AdPlacement.getIntroButtonBannerId1(), rlBannerAdView, slBannerShimmer, llBannerAd);
            } else {
                rlBannerAdView.setVisibility(View.GONE);
                rlNativeAdView.setVisibility(View.VISIBLE);
                AdPlacement.loadNativeAd(this, AdPlacement.getIntroButtonNativeId1(), rlNativeAdView, slNativeShimmer, flNativeAd, "small");
            }
        }

        btnNext.setOnClickListener(view -> IntroNavigation.goToNextIntroButtonScreen(Intro1Activity.this, 1));
    }
    ...
    protected void onResume() {
        super.onResume();
        if (tvTitle != null) {
            tvTitle.setText(getString(R.string.intro_1_title));
            tvDescription.setText(getString(R.string.intro_1_description));
