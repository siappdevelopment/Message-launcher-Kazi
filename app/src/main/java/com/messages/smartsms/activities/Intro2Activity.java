...
public class Intro2Activity extends AppCompatActivity {
    ...
    private void clickEvents() {
        ...
        if (!AdPlacement.getIntroButtonAdShow()) {
            ...
            if ("banner".equalsIgnoreCase(AdPlacement.getIntroButtonAdType())) {
                ...
                AdPlacement.loadBannerAd(this, AdPlacement.getIntroButtonBannerId2(), rlBannerAdView, slBannerShimmer, llBannerAd);
            } else {
                rlBannerAdView.setVisibility(View.GONE);
                rlNativeAdView.setVisibility(View.VISIBLE);
                AdPlacement.loadNativeAd(this, AdPlacement.getIntroButtonNativeId2(), rlNativeAdView, slNativeShimmer, flNativeAd, "small");
            }
        }

        btnNext.setOnClickListener(view -> IntroNavigation.goToNextIntroButtonScreen(Intro2Activity.this, 2));
    }
    ...
    protected void onResume() {
        super.onResume();
        if (tvTitle != null) {
            tvTitle.setText(getString(R.string.intro_2_title));
            tvDescription.setText(getString(R.string.intro_2_description));
